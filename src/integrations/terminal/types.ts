 ...
 *
 * Note: The differential types (TerminalError*) are intentionally sniffed at
 * runtime instead of being imported here. This ensures consumers that rely on
 * the original two-arg constructor (`new ShellIntegrationError(msg, submitted)`)
 * continue to work without pulling in the new type imports.
 */
